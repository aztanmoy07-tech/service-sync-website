...
// ✅ Icons as SVGs (No extra install needed)
const Icons = {
  ...
  Transport: () => <svg className="w-8 h-8 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"></path></svg>, // Swapped for generic exchange/move icon or use bus
...
const Main = () => {
  ...
  const categories = [
    { id: 'map', name: 'View Area Map', sub: 'Click to expand visual map', icon: <Icons.Map />, bg: 'bg-white' }, // Placeholder for map
    ...
    <div className="min-h-screen bg-gray-50 font-sans text-gray-800">
      ...
      <nav className="flex justify-between items-center px-6 py-4 bg-white/80 backdrop-blur-md sticky top-0 z-50 border-b border-gray-100">
        ...
        <div className="flex gap-3">
            <Link to="/dev" className="px-4 py-2 text-sm font-semibold text-gray-600 hover:text-black hover:bg-gray-100 rounded-full transition">Dev Panel</Link>
      ...
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="py-12 text-center space-y-4">
            ...
            <div className="pt-6 flex flex-col items-center gap-4">
               {/* Add Service Button */}
               <Link to="/add-service" className="flex items-center gap-2 bg-black text-white px-6 py-3 rounded-full font-bold shadow-lg hover:scale-105 transition transform">
        ...
        <div className="mb-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
               {categories.map((cat) => (
                 <button 
                   key={cat.id} 
                   onClick={() => setCategory(cat.id === 'map' ? 'All' : cat.id)} 
        ...
        <div className="pb-20">
            <div className="flex justify-between items-end mb-6">
               ...
               {category !== 'All' && (
                 <button onClick={() => setCategory('All')} className="text-sm text-red-500 font-bold hover:underline">Clear Filter</button>
               )}
            </div>
            ...
            {loading ? (
                ...
                <div className="text-center py-20 bg-white rounded-3xl border border-dashed border-gray-300">
                    <p className="text-gray-500 text-lg">No services found for "{category === 'All' ? searchTerm : category}".</p>
